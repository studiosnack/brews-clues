...
type Props = {
  ...
  // get all of them.
  onChildAdded?: (snapshot: DataSnapshot<*>) => void,
  ...
  // store.
  onChildRemoved?: (snapshot: DataSnapshot<*>) => void,
};
...
export default class DataConnection extends React.Component {
  ...
  render(){
    const {location, onChildRemoved, onChildAdded} = this.props;
    ...
    // for adding event handlers to the database, there's no need to
    return null;
  }
